...
Designed an all-in-one time-series AI training workflow for measurement-data ingestion, signal selection, preprocessing, normalization, training metrics, and deployment-format export. The public demo uses MF4-like synthetic CSV data and simplified model metrics to show the data-to-model workflow.
